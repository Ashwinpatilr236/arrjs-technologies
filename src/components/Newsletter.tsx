        ...
        <div className="card relative overflow-hidden p-8 text-center sm:p-12">
          ...
          <div className="relative mx-auto max-w-xl">
            ...
            <h3 className="mt-5 font-display text-2xl font-bold text-ink-900 dark:text-white sm:text-3xl">
              Get tech tips & product drops
            </h3>
            <p className="mt-2 text-sm text-ink-600 dark:text-ink-300">
              Join our newsletter for website tips, AI insights, PC building guides and new
            ...
            {status === 'error' && (
              <p className="mt-3 text-xs text-rose-500">Something went wrong. Please try again.</p>
            )}
          </div>
        </div>
      </div>
